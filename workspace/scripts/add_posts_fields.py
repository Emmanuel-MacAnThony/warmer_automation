"""
Adds the 7 posts intelligence fields to the CRM table via Airtable Metadata API.
...
FIELDS_TO_CREATE = [
    {
        "name": "post_wealth_signal",
        "type": "multilineText",
    },
    {
        "name": "post_giving_signal",
        "type": "multilineText",
    },
    {
        "name": "post_topic_themes",
        "type": "multipleSelects",
        "options": {"choices": []},
    },
    {
        "name": "post_engagement_tier",
        "type": "singleSelect",
        "options": {
            "choices": [
    ...
    {
        "name": "post_last_active",
        "type": "singleLineText",
    },
    {
        "name": "post_analyzed_links",
        "type": "multilineText",
    },
]
...
if __name__ == "__main__":
    print(f"Adding posts intelligence fields to: fundraising_test_table\n")
