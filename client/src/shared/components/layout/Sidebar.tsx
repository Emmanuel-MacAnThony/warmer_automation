...
import { LayoutDashboard, Briefcase, /* GitBranch, */ Mail } from 'lucide-react'
...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-linear-to-br from-primary to-emerald-700 shrink-0 shadow-lg shadow-primary/20">
          <span className="font-mono text-base font-bold text-primary-foreground leading-none">W</span>
        </div>
        <AnimatePresence>
          {!collapsed && (
            <motion.span
      ...
      <AnimatePresence>
        {!collapsed && (
          ...
          >
            <span className="font-mono text-xs text-sidebar-foreground/30 tracking-widest">v0.1.0</span>
          </motion.div>
        )}
      </AnimatePresence>
    </motion.aside>
